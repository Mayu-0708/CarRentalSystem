...
public class CarController {
    ...
    public CarConverter saveImage(CarDTO carDTO, @RequestPart("imgFrontFile") MultipartFile file1, @RequestPart("imgBackFile") MultipartFile file2, @RequestPart("imgSideFile") MultipartFile file3, @RequestPart("imgInsideFile") MultipartFile file4) {
        try {
            ...
            e.printStackTrace();
            return new CarConverter("Ok", "Successfully Saved", carDTO);
        }
        return new CarConverter("Ok", "Successfully Saved", carDTO);
    }

    @GetMapping
    public CarConverter getAllCars(){
        List<CarDTO> allCar = service.getAllCars();
        return new CarConverter("OK","Successfull",allCar);
